<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="relative z-20 w-full h-full flex flex-col px-6 md:px-16 lg:px-24 xl:px-32">
      <!-- Content block with centered on mobile, left-aligned on larger screens -->
      <div class="flex flex-col mt-auto mb-16 md:mb-20 lg:mb-28 max-w-3xl mx-auto md:mx-0 text-center md:text-left">
