    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <header class="flex items-center justify-between py-8">
        ...
        <div class="hidden md:flex items-center">
          ...
          <!-- Enhanced Partner with Us Button -->
          <NuxtLink to="/partner"
            class="ml-12 px-6 py-3 rounded-md text-sm lg:text-base font-bold text-white bg-[#406112] hover:bg-[#a86414] transition-all duration-300 whitespace-nowrap shadow-lg hover:shadow-xl shadow-[#a86414]/30 hover:shadow-[#a86414]/50 transform hover:-translate-y-0.5">
            Partner with Us
          </NuxtLink>
        </div>
      ...
      <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95"
        ...
        <div v-show="open" class="md:hidden mt-2 py-2 rounded-lg shadow-lg bg-white/95">
          ...
          <!-- Enhanced Mobile Partner Button -->
          <div class="px-4 mt-4">
            <NuxtLink to="/partner"
              class="block w-full text-center px-6 py-3 rounded-md text-sm font-bold text-white bg-[#74b41a] hover:bg-[#a86414] transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95 transform hover:-translate-y-0.5"
              @click="open = false">
              Partner with Us
            </NuxtLink>
          </div>
