<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute right-4 top-1/2 transform -translate-y-1/2 opacity-10 z-10">
      <img src="~/assets/img/wilsonsamson-logo2.png" alt="Wilson Samson Logo" class="w-72 h-72 object-contain" />
    </div>
...
/* Fade animation for descriptions */
.fade-enter-active {
