<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute right-0 top-0 w-full md:w-1/2 h-2/5 md:h-full overflow-hidden">
      ...
      <div
        class="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-l from-transparent via-slate-900/40 md:via-transparent to-slate-900/80 md:to-slate-900/20">
      </div>
    </div>
    ...
    <div
      ...
      <div class="max-w-3xl mt-8 md:mt-16">
        <!-- Hero Heading - Mobile responsive sizing -->
        <h1
          class="hero-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-tight mb-6 md:mb-12">
          Lead with
