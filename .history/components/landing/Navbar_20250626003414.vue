<script setup>
import { ref } from 'vue';
import climateSmartAgric from '@/assets/img/climate-smart agric.jpg';
import carbonSequestration from '@/assets/img/carbon-sequestration.jpg';
import ecofuelBriquettes from '@/assets/img/ecofuel-briquettes.jpg';
