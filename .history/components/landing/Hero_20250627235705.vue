<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute right-8 top-1/2 transform -translate-y-1/2 w-64 h-80 overflow-hidden rounded-lg shadow-2xl">
    ...
    <!-- Logo (Centered, smaller, inverted) -->
    <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-20 z-10">
      <img src="~/assets/img/wilsonsamson-logo2.png" alt="Wilson Samson Logo"
        class="w-32 h-32 object-contain filter invert" />
    </div>

    <!-- Main Content -->
    <div class="relative z-20 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 pt-24">
      <div class="max-w-2xl">
        <!-- Hero Heading - Shifted down and reduced size -->
        <div class="hero-heading text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-6 mt-16">
          <div class="mb-1">Lead</div>
          <div class="mb-1">with</div>
          <div class="text-blue-500">Clarity</div>
        </div>

        <!-- Animated Description Lines (Reduced size) -->
        <div class="space-y-2 mb-10">
          <transition name="fade-up" appear>
            <p v-show="showLine1" class="text-md md:text-lg text-gray-300 font-light leading-relaxed">
              Clarity sessions that sharpen your focus.
            </p>
          </transition>

          <transition name="fade-up" appear>
            <p v-show="showLine2" class="text-md md:text-lg text-gray-300 font-light leading-relaxed">
              Training that empowers your team.
            </p>
          </transition>

          <transition name="fade-up" appear>
            <p v-show="showLine3" class="text-md md:text-lg text-gray-300 font-light leading-relaxed">
        ...
        <!-- CTA Button -->
        <transition name="fade-up" appear>
          <div v-show="showButton" class="flex justify-start">
            <NuxtLink to="/contact"
    ...
    <!-- Signature (White and moved to extreme right) -->
    <div class="absolute bottom-8 right-8 z-30">
      <p class="signature-text text-3xl md:text-4xl text-white opacity-80">
        Wilson Samson
      </p>
    </div>
...
// Reactive variables for staggered animation
