<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div
      class="absolute bottom-4 right-4 md:bottom-8 md:right-8 lg:right-16 xl:right-24 2xl:right-32 z-30 mobile-signature">
...
@media (max-width: 768px) {
  ...
  .logo-container {
    ...
    left: auto;
    right: 50px;
    /* Move to right side since image is now on left */
  }
  ...
  /* Move signature more to center-right on mobile for better visibility */
  .mobile-signature {
    right: 2rem !important;
    /* Increased from 1rem to 2rem to move signature more to the right */
...
@media (max-width: 640px) {
  ...
  /* Keep signature on bottom right but more visible on mobile */
  .mobile-signature {
