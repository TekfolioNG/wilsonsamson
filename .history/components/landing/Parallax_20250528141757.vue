        ...
        <div class="parallax-container" ref="parallaxContainer">
            ...
            <div class="content-container">
                <div class="caption-box">
                    <h3 class="caption-title">We are driven by purpose, built on expertise, and committed to delivering real value, every step of the way.</h3>
                    <div class="cta-container">
                        <NuxtLink to="/who-we-do" class="primary-cta">Our Services</NuxtLink>
