            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden relative">
                    <div class="animation-container relative w-full h-full flex items-center justify-center">
                        ...
                        <!-- Pen icon for writing simulation -->
                        <div ref="pen" class="absolute w-6 h-6 z-20" :style="penStyle">
                        ...
                        <div v-if="!isAnimating && !animationComplete"
                            ...
                            Your idea will be reviewed and considered for implementation.
                        </div>
                    </div>
                </div>
            </div>
...
// Update pen position based on form input
const updatePenPosition = (field) => {
    if (field === 'subject') {
        penX.value = 100; // Adjust based on paper position
        penY.value = 50;
