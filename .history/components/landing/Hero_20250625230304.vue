<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="relative z-20 w-full h-full flex flex-col px-6 md:pl-16 lg:pl-24 xl:pl-32">
      <!-- Added proper spacing from top to avoid navbar clash -->
      <div
        class="flex flex-col justify-center h-full pt-24 md:pt-16 pb-20 md:pb-24 lg:pb-28 max-w-3xl mx-auto md:mx-0 mobile-content-position">
