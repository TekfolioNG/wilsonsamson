<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <!-- Mobile Background Gradient (behind image) -->
    <div
      class="md:hidden absolute right-0 top-0 w-1/2 h-full bg-gradient-to-l from-transparent via-slate-900/40 to-slate-900/80">
    </div>
    ...
    <div class="absolute right-0 md:right-0 top-0 w-1/2 md:w-1/2 h-full overflow-hidden">
      ...
      <div class="hidden md:block absolute inset-0 bg-gradient-to-l from-transparent via-transparent to-slate-900/20">
      </div>
    </div>
...
@media (max-width: 768px) {
  ...
  .mobile-content-center {
    ...
    /* Move content down slightly from -10vh */
    margin-left: auto;
    margin-right: auto;
  }
