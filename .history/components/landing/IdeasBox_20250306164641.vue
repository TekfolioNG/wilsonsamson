            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden relative">
                    <div class="animation-container relative w-full h-full flex items-center justify-center min-h-64">
                        ...
                        <div ref="paper"
                            class="absolute w-36 h-44 bg-white border-2 border-gray-300 rounded-md shadow-md z-10 transform-gpu"
                            :style="paperStyle">
                        ...
                        <div class="absolute bottom-20 w-48 h-36">
                            ...
                            <div v-if="showIdeasCount"
                                class="absolute -top-4 -right-2 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">
                                {{ ideasCount }}
                            </div>
                        </div>
                        ...
                        <div v-if="!isAnimating && !animationComplete"
                            ...
                            Ideas submitted here are reviewed within 48 hours by our team
                        </div>
                    </div>
                </div>
            </div>
