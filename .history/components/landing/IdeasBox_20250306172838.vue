...
const paperStyle = computed(() => ({
    ...
    transform: `translate(-50%, -50%) ${animationComplete.value ? 'scale(0.8) rotate(5deg)' : 'scale(0.85) rotate(-8deg)'}`, // Reduced scale and increased tilt
    opacity: 1,
...
const addPaperHoverEffect = () => {
    if (paper.value) {
        paper.value.addEventListener('mouseenter', () => {
