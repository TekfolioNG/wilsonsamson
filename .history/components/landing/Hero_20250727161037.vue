<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute inset-0 mobile-bg-opacity md:opacity-5">
    ...
    <div
      ...
      <div class="max-w-3xl mt-8 md:mt-24 mobile-content-center">
        <!-- Hero Heading - Mobile responsive sizing with reduced bottom margin -->
        <h1
          class="hero-heading text-5xl sm:text-6xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-tight mb-2 md:mb-4">
          Lead with
          <span class="text-blue-500">Clarity</span>
        </h1>

        <!-- Single Sliding Description Line - Mobile responsive with reduced margins -->
        <div class="relative h-12 md:h-16 mb-4 md:mb-6">
        ...
        <div class="flex justify-start mobile-button-center">
          <NuxtLink to="/contact"
            ...
            <span class="relative z-10 text-center">Click Here to Lead Smarter, Grow Faster</span>
            <div
            ...
            <svg
              class="ml-2 md:ml-3 w-4 h-4 md:w-5 md:h-5 transition-transform duration-300 group-hover:translate-x-1 hidden md:block"
...
.bg-mobile-shifted {
  ...
  /* Adjust percentage to shift more/less */
}
