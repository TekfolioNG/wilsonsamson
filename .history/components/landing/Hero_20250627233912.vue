<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="relative z-20 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32">
      <div class="max-w-3xl">
        <!-- Hero Heading - Static -->
        <h1 class="hero-heading text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-tight mb-8">
          Lead with
        ...
        <div class="space-y-4 mb-12">
          <transition name="fade-up" appear>
            <p v-show="showLine1" class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed">
              Clarity sessions that sharpen your focus.
            </p>
          </transition>

          <transition name="fade-up" appear>
            <p v-show="showLine2" class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed">
              Training that empowers your team.
            </p>
          </transition>

          <transition name="fade-up" appear>
            <p v-show="showLine3" class="text-xl md:text-2xl text-gray-300 font-light leading-relaxed">
