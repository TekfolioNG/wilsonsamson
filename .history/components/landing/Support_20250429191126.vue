        ...
        <div class="parallax-container" ref="parallaxContainer">
            ...
            <div class="content-container">
                <div class="caption-box">
                    <h3 class="caption-title">Building sustainable futures through compassionate action and innovative
                        solutions</h3>
                    <div class="cta-container">
                        <NuxtLink to="/who-we-are" class="primary-cta">Learn Our Story</NuxtLink>
                        <NuxtLink to="/how-to-help" class="secondary-cta">Support Our Mission</NuxtLink>
                    </div>
                </div>
            </div>
        </div>
...
import heroImage from '~/assets/img/construction-workers.jpeg';
