    ...
    <div class="min-h-screen bg-white py-16 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <!-- Form section -->
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl h-96">
                    <div class="p-8">
...
const paperStyle = computed(() => ({
    top: isAnimating.value ? '50%' : '15%',
    left: isAnimating.value ? '50%' : '75%',
