<template>
    <section
        class="impact-metrics-section bg-gray-100 relative w-screen py-10 sm:py-12 translate-x-[-5%] sm:translate-x-[-2.8%] mb-4">
...
.metrics-container {
    max-width: 900px;
    /* Reduced from 1000px to make section smaller */
    margin: 0 auto;
}

/* Updated header styling for single-line h3-sized heading */
.metrics-header {
    text-align: center;
...
.metrics-map {
    ...
    /* Reduced margin between map and metrics */
    border-radius: 8px;
    overflow: hidden;
