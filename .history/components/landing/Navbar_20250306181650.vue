      ...
      <header class="flex flex-col lg:flex-row justify-between items-center py-5">
        ...
        <div class="hidden lg:flex flex-col gap-2">
          ...
          <div class="flex gap-2">
            <!-- New "SUGGEST AN IDEA" button -->
            <NuxtLink to="/idea-box"
              class="bg-[#28a745] text-white px-3 py-1.5 rounded-lg flex items-center gap-1 hover:bg-[#218838] text-sm">
            ...
            <!-- Existing "SUPPORT A PROJECT" button -->
            <NuxtLink to="/donate"
        ...
        <div class="lg:hidden flex flex-col gap-4 mt-4 bg-white/0 backdrop-blur-sm p-4 rounded-lg w-full text-center"
          ...
          <div class="flex justify-center gap-2 flex-wrap">
            <!-- New "SUGGEST AN IDEA" button for mobile -->
            <NuxtLink to="/idea-box"
              class="bg-[#28a745] text-white px-3 py-1.5 rounded-lg flex items-center gap-1 hover:bg-[#218838] text-sm">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                <path
            ...
            <!-- Existing "SUPPORT A PROJECT" button for mobile -->
            <NuxtLink to="/donate"
              class="bg-[#901F61] text-white px-3 py-1.5 rounded-lg flex items-center gap-1 hover:bg-[#A82C6F] text-sm">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
