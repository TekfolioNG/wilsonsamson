<template>
    <div class="min-h-screen bg-gradient-to-br from-teal-50 via-emerald-50 to-teal-100 py-16 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <!-- Animation container -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden h-96 relative">
                    <div class="animation-container relative w-full h-full flex items-center justify-center">
                        ...
                        <div ref="paper"
                            ...
                            <div class="w-3/4 h-1.5 bg-gray-300 mx-auto mt-4"></div>
                            <div class="w-3/4 h-1.5 bg-gray-300 mx-auto mt-3"></div>
                            <div class="w-3/4 h-1.5 bg-gray-300 mx-auto mt-3"></div>
                            <div class="w-1/2 h-1.5 bg-gray-300 mx-auto mt-3"></div>
...
// Initial styles - paper is visible but at its starting position
const paperStyle = computed(() => ({
    top: isAnimating.value || animationComplete.value ? '50%' : '30%',
    left: isAnimating.value || animationComplete.value ? '50%' : '50%',
    transform: `translate(-50%, -50%) ${animationComplete.value ? 'scale(0.8) rotate(5deg)' : 'scale(1) rotate(0deg)'}`,
    opacity: 1
}));
...
const submitIdea = async () => {
    ...
    try {
        ...
        // Paper animation sequence - paper floats to box
        tl.to(paper.value, {
            top: '40%',
            duration: 0.5,
            ease: "power1.out"
