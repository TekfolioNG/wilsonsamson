  ...
  <div class="fixed w-full z-50 top-0 left-0 right-0">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <header class="flex items-center py-3">
        <!-- Logo section with minimal effects -->
        <div class="w-1/3">
        ...
        <nav class="hidden md:flex items-center justify-center w-1/3 fixed-nav">
        ...
        <!-- Color Mode Toggle - with specified background color -->
        <div class="hidden md:flex items-center justify-end w-1/3">
          <ClientOnly v-if="!colorMode?.forced">
            <div class="bg-primary-dark rounded-lg p-1">
        ...
        <div class="md:hidden ml-auto flex items-center">
          ...
          <ClientOnly v-if="!colorMode?.forced" class="mr-2">
            <div class="bg-primary-dark rounded-lg p-0.5">
