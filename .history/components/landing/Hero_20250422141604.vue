      ...
      <div class="flex flex-col mt-auto mb-16 md:mb-20 lg:mb-28 max-w-3xl mx-auto md:mx-0">
        ...
        <div class="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
          <NuxtLink :to="slides[currentSlide].primaryLink"
            class="px-6 py-3 border-2 text-white font-medium transition-all duration-300 text-lg transform active:bg-yellow-500 active:text-black active:scale-95 hover:bg-yellow-500 hover:text-black hover:scale-105 focus:bg-yellow-500 focus:text-black focus:outline-none">
            {{ slides[currentSlide].primaryText }}
          </NuxtLink>
          <NuxtLink :to="slides[currentSlide].secondaryLink"
            class="px-6 py-3 border-2 text-white font-medium transition-all duration-300 text-lg transform active:bg-white active:text-black active:scale-95 hover:bg-white hover:text-black hover:scale-105 focus:bg-white focus:text-black focus:outline-none">
...
@media (max-width: 767px) {
  ...
  /* Force touch color change on mobile */
  a:active {
...
/* This helps with iOS touch devices */
@media (hover: none) {
  a:hover {
