      ...
      <div class="flex flex-col mt-auto mb-16 md:mb-20 lg:mb-28 max-w-3xl mx-auto md:mx-0">
        <transition name="slide-up" mode="out-in">
          <h1 :key="'title-' + currentSlide"
            class="hero-heading font-heading text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white font-black tracking-wider-custom leading-tight">
            {{ slides[currentSlide].title }}
          </h1>
        </transition>
        <transition name="slide-up" mode="out-in">
          <p :key="'desc-' + currentSlide"
            class="mt-6 text-xl md:text-2xl lg:text-3xl text-gray-100 max-w-4xl font-medium leading-relaxed">
