      ...
      <header class="flex flex-col lg:flex-row justify-between items-center py-5">
        <div class="flex w-full lg:w-auto items-center justify-between">
          ...
          <a href="/" class="text-lg">
            <img src="~/assets/img/toei-logo-header.png" alt="Petabiz Nigeria" class="h-20" />
          </a>
          <!-- Mobile Menu Toggle -->
        ...
        <div class="hidden lg:flex flex-col gap-2">
          ...
          <div class="flex gap-2">
            ...
            <NuxtLink to="/donate"
              class="bg-[#901F61] text-white px-2.5 py-1 rounded-lg flex items-center gap-1 hover:bg-[#A82C6F] text-xs">
            ...
            <NuxtLink to="/idea-box"
              class="bg-emerald-700 text-white px-2.5 py-1 rounded-lg flex items-center gap-1 hover:bg-emerald-800 text-xs">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z" />
                <path
                  d="M15 7v2a4 4 0 01-4 4H9.828l-1.766 1.767c-.28.28-.732.28-1.012 0L5.586 13H4a4 4 0 01-4-4V5a4 4 0 014-4h7a4 4 0 014 4v2z" />
              </svg>
              SUGGEST AN IDEA
            </NuxtLink>
          </div>
