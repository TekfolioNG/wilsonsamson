...
@media (max-width: 767px) {
  .mobile-bg-shift {
    background-image: radial-gradient(circle at 80% 50%, rgba(120, 119, 198, 0.3) 0%, transparent 50%), radial-gradient(circle at 140% 50%, rgba(255, 255, 255, 0.1) 0%, transparent 50%) !important;
  }
}
</style>