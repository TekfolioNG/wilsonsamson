<template>
  <section class="xstrato-cta relative py-16 md:py-24 overflow-hidden mb-16 md:mb-24">
    ...
    <div class="absolute inset-0">
      ...
      <div class="absolute top-0 right-0 w-full h-full bg-gradient-to-bl from-blue-900/30 to-transparent transform skew-y-1 origin-top-right"></div>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
        ...
        <div class="space-y-6">
          ...
          <p class="text-lg text-white/80 leading-relaxed">
            Whether it's construction excellence, comprehensive training programs, or sustainable solar solutions, 
            Xstrato delivers results that exceed expectations. Let's collaborate to create something extraordinary.
          </p>

          <div class="flex flex-col sm:flex-row gap-4 pt-4">
            <a href="/contact" 
               class="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
          ...
          <div class="relative p-8">
            ...
            <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
              <div class="space-y-6">
                ...
                <div class="flex items-center space-x-4">
                  <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-400 rounded-full flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-4">
                  <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-400 rounded-full flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p class="text-white/70 text-sm">Dedicated professionals in every field</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-br from-blue-400 to-cyan-300 rounded-full opacity-60"></div>
            <div class="absolute -bottom-2 -left-2 w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-300 rounded-full opacity-40"></div>
          </div>
        </div>
      </div>
    </div>
