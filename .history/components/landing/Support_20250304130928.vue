<template>
    <section class="parallax-hero w-screen max-w-screen -mx-[8vw] sm:-mx-[3.8vw]">
        <div class="parallax-container" ref="parallaxContainer">
            <div class="parallax-image w-full h-full object-cover object-center transition-transform duration-300 hover:scale-105"
                ref="parallaxImage"></div>
