<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <!-- Hero Image - Mobile: left half, Desktop: right half -->
    <div class="absolute left-0 md:right-0 top-0 w-1/2 md:w-1/2 h-full overflow-hidden">
    ...
    <div class="absolute right-8 md:left-150 top-3/4 md:top-1/2 transform -translate-y-1/2 z-10 logo-container">
    ...
    <div class="absolute bottom-4 right-8 md:bottom-8 md:right-8 lg:right-16 xl:right-24 2xl:right-32 z-30">
...
@media (max-width: 768px) {
  ...
  /* Adjust logo on mobile - move to right side since image is now on left */
  .logo-container {
    opacity: 0.15;
    right: 2rem;
...
@media (max-width: 640px) {
  ...
  /* Move signature more to the right on mobile for better visibility */
  .signature-text {
    position: absolute;
    bottom: 8px;
    right: 16px;
    /* Increased from 8px to 16px to move more to the right */
    left: auto;
  }
