<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="relative z-20 w-full h-full flex flex-col px-6 md:pl-16 lg:pl-24 xl:pl-32">
      ...
      <div
        class="flex-1 flex flex-col justify-center pt-32 md:pt-40 lg:pt-44 pb-32 md:pb-20 lg:pb-28 mx-auto hero-content-container"
        :class="{ 'items-end': currentSlide === 0, 'items-start': currentSlide !== 0 }">
        <transition name="fade-slow" mode="out-in">
          <h1 :key="'title-' + currentSlide"
            ...
            :class="{ 'text-right pr-0 md:pr-16 lg:pr-24 xl:pr-32': currentSlide === 0 }">
            {{ slides[currentSlide].title }}
          </h1>
        </transition>
        <transition name="fade-slow" mode="out-in">
          <p v-if="slides[currentSlide].description" :key="'desc-' + currentSlide"
            ...
            :class="{ 'text-right ml-auto': currentSlide === 0 }"
        ...
        <transition name="fade-slow" mode="out-in">
          <div v-if="slides[currentSlide].buttonText" :key="'button-' + currentSlide" class="mt-8 w-full flex"
            :class="{ 'justify-end': currentSlide === 0, 'justify-start': currentSlide !== 0 }">
