<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute right-0 md:right-0 top-0 w-1/2 md:w-1/2 h-full overflow-hidden">
      ...
      <div
        class="absolute inset-0 bg-gradient-to-l md:bg-gradient-to-l from-transparent via-slate-900/40 md:via-transparent to-slate-900/80 md:to-slate-900/20">
      </div>
    </div>
    ...
    <div
      class="relative z-20 w-full md:w-full h-full flex flex-col justify-center md:justify-center px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 mobile-content-container">
...
@media (max-width: 768px) {
  ...
  /* Center content on mobile and move up */
  .mobile-content-center {
    ...
    /* Move content down more */
    margin-left: auto;
    margin-right: auto;
  }

  /* Limit content container width on mobile to not cover image */
  .mobile-content-container {
    width: 45%;
    /* Reduce width to give more space for image */
  }
  ...
  .logo-container {
    opacity: 0.15;
    left: 50px;
    /* Move back to left side since image is now on right */
    right: auto;
  }
...
@media (max-width: 640px) {
  ...
  /* Keep logo visible on mobile since image is now half-width */
  .logo-container {
    display: block;
    opacity: 0.1;
  }
