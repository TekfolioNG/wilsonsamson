      ...
      <div class="flex flex-col mt-auto mb-16 md:mb-20 lg:mb-28 max-w-3xl">
        ...
        <div class="mt-8 flex flex-wrap gap-4">
          <<NuxtLink :to="slides[currentSlide].primaryLink"
            class="px-6 py-3 bg-yellow text-black hover:bg-transparent hover:border-yellow hover:text-black border-2 border-yellow font-medium transition-all duration-300 text-lg transform hover:scale-105">
