    ...
    <section
        ...
        <div class="metrics-container">
            ...
            <div class="metrics-layout">
                ...
                <!-- Metrics cards on the right for desktop, below for mobile -->
...
/* Added for desktop layout - contains map and metrics in side-by-side layout */
.metrics-layout {
    display: flex;
...
@media (min-width: 768px) {
    ...
    .metrics-map {
        flex: 2;
        /* Takes up more space than the metrics */
        margin-bottom: 0;
    ...
    .metrics-grid {
        flex: 1;
        /* Takes up less space than the map */
