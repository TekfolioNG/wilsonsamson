<template>
  <main class="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
    ...
    <div class="absolute inset-0 opacity-5">
      <div class="absolute inset-0 mobile-bg-shift"
...
@media (max-width: 767px) {
  .mobile-bg-shift {
    background-image: radial-gradient(circle at 150% 50%, rgba(120, 119, 198, 0.3) 0%, transparent 50%), radial-gradient(circle at 200% 50%, rgba(255, 255, 255, 0.1) 0%, transparent 50%) !important;
  }
}
</style>