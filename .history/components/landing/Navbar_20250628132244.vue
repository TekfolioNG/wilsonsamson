...
const menuitems = [
  ...
  { title: "Clarity Sessions", path: "/clarity-sessions" },
...
const textColorClass = 'text-white/50 hover:text-gray-700 hover:bg-white/50';
const progressBarColor = 'bg-white/50';
</script>
        ...
        <div class="hidden md:flex items-center w-full">
            ...
            <ul class="flex space-x-6 lg:space-x-8">
              <li v-for="item in menuitems" :key="item.title" class="relative">
                <NuxtLink :to="item.path" :class="[
                  'text-xs lg:text-sm transition-all duration-300 flex items-center whitespace-nowrap font-medium text-white/50 hover:text-white hover:scale-105 hover:font-semibold relative group',
          ...
          <div class="hidden md:flex items-center ml-auto">
            <NuxtLink to="/contact"
              ...
              <div class="absolute bottom-0 right-4 h-0.5 bg-gray-700 rounded-full transition-all duration-300 ease-out"
                :class="[
