<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="relative z-20 w-full h-full flex flex-col px-6 md:px-16 lg:px-24 xl:px-32">
      <div class="flex flex-col mt-auto mb-24 md:mb-32 lg:mb-40 max-w-3xl">
        <transition :name="textTransitions[currentSlide]" mode="out-in">
          <h1 :key="'title-' + currentSlide"
            class="font-heading text-4xl md:text-5xl lg:text-6xl text-white font-extrabold tracking-wider-custom leading-tight">
        ...
        <div class="mt-6 flex flex-wrap gap-4">
          <NuxtLink :to="slides[currentSlide].primaryLink"
            class="px-6 py-3 bg-yellow text-black hover:bg-yellow-500 font-medium transition-all duration-300 text-lg transform hover:scale-105">
