    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <header class="flex items-center justify-between py-8">
        ...
        <div class="hidden md:flex items-center">
          ...
          <NuxtLink to="/partner"
            class="ml-12 px-6 py-3 rounded-md text-sm lg:text-base font-medium text-white bg-[#74b41a] hover:bg-[#a86414] transition-colors duration-200 whitespace-nowrap">
            Partner with Us
          </NuxtLink>
        </div>
      ...
      <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95"
        ...
        <div v-show="open" class="md:hidden mt-2 py-2 rounded-lg shadow-lg bg-white/95">
          ...
          <div class="px-4 mt-4">
            <NuxtLink to="/partner"
              class="block w-full text-center px-4 py-3 rounded-md text-sm font-medium text-white bg-[#a86414] hover:bg-[#74b41a] transition-all duration-200 shadow-md hover:shadow-lg"
              @click="open = false">
              Partner with Us
            </NuxtLink>
          </div>
