...
useSeoMeta({
  ...
  description: 'Get in touch with PPIL for inquiries, partnerships, or project discussions',
  ogDescription: 'Get in touch with PPIL for inquiries, partnerships, or project discussions',
})
</script>
          ...
          <div class="lg:w-1/2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
              ...
              <div v-if="formStatus.message" :class="{
                'bg-green-100 border-green-400 text-green-700': formStatus.success,
                'bg-red-100 border-red-400 text-red-700': formStatus.error,
                'bg-blue-100 border-blue-400 text-blue-700': formStatus.loading
