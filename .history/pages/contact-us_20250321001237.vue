...
useSeoMeta({
  ...
  titleTemplate: '%s | The OakTree Empowerment Initiative',
  description: 'Get in touch with The OakTree Empowerment Initiative team. We\'re here to help you make a difference.',
  ogDescription: 'Get in touch with The OakTree Empowerment Initiative team. We\'re here to help you make a difference.',

  twitterCard: 'summary_large_image',
  twitterTitle: 'Contact Us - The OakTree Empowerment Initiative',
  twitterDescription: 'Get in touch with The OakTree Empowerment Initiative team. We\'re here to help you make a difference.',

  ogImage: {
    url: 'https://oaktreeinitiative.org/images/oaktree-social-banner.jpg',
    width: 1200,
    height: 630,
    alt: 'The OakTree Empowerment Initiative - Rebuilding Lives & Communities'
  },
  twitterImage: 'https://oaktreeinitiative.org/images/oaktree-social-banner.jpg'
});

// Form data state
const formData = reactive({
  access_key: 'YOUR-WEB3FORMS-ACCESS-KEY-HERE', // Replace with your actual Web3Forms access key
  name: '',
  email: '',
  phone: '',
  inquiry_type: '',
