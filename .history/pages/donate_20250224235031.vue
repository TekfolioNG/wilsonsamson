<template>
    <!-- Brand Logo at the Top Left of the Page -->
    <a href="/" class="absolute top-8 left-8 z-30">
        <img src="~/assets/img/Petabiz_logo.png" alt="Oaktree Empowerment Initiative" class="h-12" />
    </a>
