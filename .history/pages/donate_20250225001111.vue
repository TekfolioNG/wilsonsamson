<template>
    <div>
        ...
        <div class="w-full h-64 md:h-96 relative">
            <img src="~/assets/img/toei_donate_hero.jpg" alt="The Oaktree Empowerment Initiative"
                class="w-full h-full object-cover" />
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <div class="text-white text-center">
                    <h1 class="text-4xl md:text-5xl font-bold mb-4">Empower Change Today</h1>
                    <p class="text-lg md:text-xl">Your support transforms lives and communities</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-8">
            ...
            <div class="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden mt-8 mb-8">
                    ...
                    <div class="w-full md:w-1/2 p-8 lg:p-12">
                        <div class="mb-8">
                            ...
                            <div class="space-y-2 text-gray-600">
                                <p class="text-lg">Your contribution creates ripples of positive change in our
                                    community.
                                    Every donation, no matter the size, helps build a better tomorrow.</p>
                                <p class="italic text-gray-500">Select a cause close to your heart and join us in making
                                    a
                                    difference.</p>
                            </div>
                        </div>
