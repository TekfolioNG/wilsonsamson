      ...
      <div class="container mx-auto px-6 md:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/hospital-renovation.jpg" alt="Healthcare Infrastructure Development"
          ...
          <!-- Project 2 -->
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/water-drilling.jpg" alt="Solar Powered Water Infrastructure"
              class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Project 3 -->
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/hangar-maintenance.jpg" alt="University Equipment Procurement"
              class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Project 4 -->
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/bridge-construction-site.jpg" alt="Telecommunications Infrastructure"
              class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Project 5 -->
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/residential-building3.jpg" alt="Educational Infrastructure Rehabilitation"
              class="w-full h-48 object-cover">
            <div class="p-6">
          ...
          <!-- Project 6 -->
          <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <img src="~/assets/img/residential-building2.jpg" alt="Digital Marketing Strategy"
              class="w-full h-48 object-cover">
            <div class="p-6">
