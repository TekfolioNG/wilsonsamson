    ...
    <div class="relative overflow-hidden">
      ...
      <div class="w-full h-64 md:h-80 lg:h-[500px] relative overflow-hidden">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center px-4 md:px-8">
          ...
          <!-- CTA Button -->
          <a href="#donate-form" class="bg-[#CEE377] hover:bg-[#daf090] text-gray-800 font-medium px-4 py-2 md:px-8 md:py-4 
          ...
          <div class="hidden md:block w-1/2 relative">
            ...
            <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
              <div class="text-white text-center p-8">
                <h1 class="text-3xl font-bold mb-4">Together We Can</h1>
          ...
          <div class="w-full md:w-1/2 p-6 md:p-8 lg:p-12">
            <div class="mb-6 md:mb-8">
              ...
              <div class="space-y-2 text-gray-600">
                <p class="text-base md:text-sm">Your contribution creates ripples of positive change in
                  our
